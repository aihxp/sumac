...
pub use inspect::{inspect_cli, load_profile, parse_command_spec, profile_value};
pub use materialize::{
    ...
    materialize_artifacts, materialize_artifacts_with_apply_selection,
};
pub use model::{
    host_profile_spec, AiClientProfile, AiCoverage, ApplyStrategy, ArtifactAudience, ArtifactMode,
    CliSurfaceProfile, ConfigShape, GeneratedArtifact, HostProfileSpec, WriteOutcome,
